...
function buildEmailHtml(fields, pathnames, attachedCount) {
  const rows = [
    ...
    ['City', fields.city],
    ['Role', fields.role],
    ['Opening Width', fields.opening_width],
    ['Opening Height', fields.opening_height],
    ['Floor-to-Ceiling Height', fields.floor_to_ceiling_height],
    ['Notes', fields.notes],
...
module.exports = async (req, res) => {
  ...
  const fields = {
    ...
    city: body.city,
    role: body.role,
    opening_width: body.opening_width,
    opening_height: body.opening_height,
    floor_to_ceiling_height: body.floor_to_ceiling_height,
    notes: body.notes,
